...
for tau in taus:
    ...
    result=Parabolic_Equation_forward(h,tau,a,f,x_range,t_range,u0t,u1t,ux0,2,1)
...
for tau in taus:
    ...
    for i in range(M+1):
        for j in range(N+1):
            true[i,j]=objfun(x_range[0]+j*h,t_range[0]+i*tau)
    result=Parabolic_Equation_backward(h,tau,a,f,x_range,t_range,u0t,u1t,ux0,2,1)
    error=np.abs(true-result)
    max_error.append(error.max())
taus2=['{:.4f}'.format(i) for i in taus]
max_error2=['{:.4f}'.format(i) for i in max_error]  
...
for tau in taus:
    ...
    for i in range(M+1):
        for j in range(N+1):
            true[i,j]=objfun(x_range[0]+j*h,t_range[0]+i*tau)
    result=Parabolic_Equation_CN(h,tau,a,f,x_range,t_range,u0t,u1t,ux0,2,1)
    error=np.abs(true-result)
    max_error.append(error.max())
taus2=['{:.4f}'.format(i) for i in taus]
max_error2=['{:.4f}'.format(i) for i in max_error]  
...
h=1/20
tau=1/1000
result1=Parabolic_Equation_forward(h,tau,a,f,x_range,t_range,u0t,u1t,ux0,2,1)
result2=Parabolic_Equation_backward(h,tau,a,f,x_range,t_range,u0t,u1t,ux0,2,1)
result3=Parabolic_Equation_CN(h,tau,a,f,x_range,t_range,u0t,u1t,ux0,2,1)
